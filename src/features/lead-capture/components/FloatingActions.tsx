...
export function FloatingActions({ onOpenLeadForm }: FloatingActionsProps) {
  return (
    <div className="fixed right-4 bottom-4 z-30 flex flex-col gap-3 sm:right-6 sm:bottom-6">
      <a
